...
<html lang="en">
<head>
	<title>Sahabat Belajar Nusantara</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title">
					<div class="login100-form-title">
					<img src="login-ui/images/logo.png" alt="">
				</div>
				</div>
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="username" placeholder="Masukan Nama Lengkap">
